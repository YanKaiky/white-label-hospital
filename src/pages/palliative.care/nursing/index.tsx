  ...
  return (
    <Box>
      <Typography textAlign='justify' fontWeight={300} marginTop={5} fontSize={20}>
        Para se definir a prática dos cuidados paliativos é fundamental que se tenha uma abordagem multidisciplinar que produza uma assistência harmônica, onde o foco é
        amenizar e controlar os sintomas de ordem física, psicológica, social e espiritual e não de buscar a cura de determinada doença.
      ...
      <Typography textAlign='justify' fontWeight={300} marginTop={2} fontSize={20}>
        ...
        auxílio com limpeza e higiene, atendimento familiar são algumas das atividades que fazem parte das atribuições do enfermeiro, oferecendo sempre atenção e conforto.
      </Typography>
    </Box>
  );
};
